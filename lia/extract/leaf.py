...
from lia.basic.evaluate.background import is_background_black
from lia.basic.get.contours import (
    BLANK_RATIO,
    CANNY_THRESH1,
    CANNY_THRESH2,
    MIN_CNTS_RATIO,
...
from lia.basic.get.difference import (
    BEYOND_ERROR_ELLIPSE,
    DIFF_ELLIPSE_SIZE,
    get_diff_ellipse,
)
from lia.basic.get.image import (
    LEAF_COLOR_FORMAT,
    LEAF_COLOR_LOWER,
    LEAF_COLOR_UPPER,
    get_image_in_color_range,
)
...
def extract_leaf_by_color(
    ...
    """
    mask = get_image_in_color_range(
        img, lower=lower, upper=upper, color_format=color_format
    )
